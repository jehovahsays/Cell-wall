...
define('BLACKHOLE_PATH', realpath(getenv('DOCUMENT_ROOT')) . '/blackhole/');
...
function blackhole_checkbot($ip, $ua, $request) {
	...
	if (($badbot === 0) && (strpos($request, '/blackhole/') === false)) return -1;
	...
	<body>
	   ...
	   id="&#x70;&#x61;&#x67;&#x65;&#x2D;&#x77;&#x72;&#x61;&#x70;">		
		...
		required>		               
			...
			<h3>Your IP Address is <?php $localIp = gethostbyname(gethostname());
echo $localIp; ?></h3>
